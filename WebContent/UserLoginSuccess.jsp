...
<button class="btn" type="submit" onclick="window.location.href='userViewData';" style="background-color: turquoise;color:black;position:absolute; top:25%; left:1%;">View Data</button>
	...
	<script
		...
		crossorigin="anonymous"></script>
	<div class="footer">
		<small style="color:white;">&copy; Created by: Anita U Mallannavar,</small><small style="color:white;">&ensp;anitaum007@gmail.com</small>&ensp;<small style="color:white;">|</small><small style="color:lightgreen;">&ensp;Last login time: ${userDto.updatedDate}</small>
	</div>
</body>
</html>